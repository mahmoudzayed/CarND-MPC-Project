...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    //this bump up te position of all the other values
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // set actuated states
double max_angle = 25 * M_PI/180;
  for (t = delta_start; t < a_start; t++)
  {
    vars_lowerbound[t] = -max_angle;
    vars_upperbound[t] = max_angle;
  }

  // set accelation
  for (t = a_start; t < n_vars; t++)
  {
